...
[Open the live demo](https://allergyfolio.onrender.com/) · [Source repository](https://github.com/allergyfolio/app)

Keep the important details close.

Allergy information supplied through FinchNode. [Explore FinchNode](https://finchnode.com).

## What this app does

Inspect recorded allergy reaction, severity and verification; optionally include medications and print a clearly fictional summary.
...
`allergyfolio.com` was unregistered in the .com registry on 2026-09-08. This is an availability signal, not a reservation; verify the registrar offer before purchasing. No domain has been bought.
